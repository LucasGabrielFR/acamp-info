                    ...
                    <div class="col-4">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_baptized"
                                        id="is_baptized" value="0" checked>
                                    <label class="form-check-label">
                                        Não
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_confirmed"
                                        id="is_confirmed" value="0" checked>
                                    <label class="form-check-label">
                                        Não
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_eucharist"
                                        id="is_eucharist" value="0" checked>
                                    <label class="form-check-label">
                                        Não
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_pastoral"
                                            id="is_pastoral" value="0" checked>
                                        <label class="form-check-label">
                                            Não
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_spouse_camper"
                                            id="is_spouse_camper" value="1" disabled>
                                        <label class="form-check-label">
                                            Sim
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_spouse_camper"
                                            id="is_spouse_camper" value="0" disabled>
                                        <label class="form-check-label">
                                            Não
                                        </label>
                                    </div>
