                        ...
                        <td>
                            @php
                                foreach ($person->markers as $marker) {
                                    if ($marker->type_name == 'FAC') {
                                        echo '<span class="badge badge-primary">' . $marker->camp_name . '</span>';
                                    } elseif ($marker->type_name == 'Juvenil') {
                                        echo '<span class="badge badge-warning">' . $marker->camp_name . '</span>';
                                    } elseif ($marker->type_name == 'Sênior') {
                                        echo '<span class="badge badge-danger">' . $marker->camp_name . '</span>';
                                    }
                                }
                            @endphp
                        </td>
